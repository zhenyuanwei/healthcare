...
urlpatterns = [
    ...
    url(r'^Health/Admin/doctorlist/$', dbmainten.goDoctorInfoList),
    url(r'^Health/Admin/dodoctor/$', dbmainten.addDoctorInfo),
    url(r'^Health/Admin/dodoctordelete/$', dbmainten.deleteDoctorInfo),
    url(r'^Health/Admin/doctorupdate/$', dbmainten.goUpdateDoctorInfo),
