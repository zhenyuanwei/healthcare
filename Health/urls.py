...
urlpatterns = [
    ...
    url(r'^admin/membershipmonthlylist/$', dbmainten.goMembershipMonthlyList),
    #url(r'^admin/querymembershipmonthlylist/$', dbmainten.queryMembershipMonthlyList),
    ...
    url(r'^admin/membershipend/$', dbmainten.goMembershipEnd),
    ...
    url(r'^admin/gomessagelist/$', dbmainten.goMessageList),
    url(r'^admin/goaddmessage/$', dbmainten.goAddMessage),
    url(r'^admin/doaddmessage/$', dbmainten.doAddMessage),
    ...
    url(r'^admin/gounpayedcopy/$', payment.goUnpayedCopy),
